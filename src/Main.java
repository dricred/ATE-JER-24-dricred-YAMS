...
public class Main {
     ...
     */
    private static String[] retourneValeurEcrit(DesEnMain desEnMain
    ) {
        String reponseDesRelance = demandeUneReponse("Quelles dés voulez-vous relancer [1 à " + desEnMain.getNbrDes()
     ...
     */
    private static void relancerDes(int[] tableauEntiers, int nbrJetDe, DesEnMain desEnMain, Combinaison combinaison) {
        int nbrLancer = 1;
        ...
        do {
            ...
            if (estOui) {
                for (String element : retourneValeurEcrit(desEnMain)) {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < NOMBRE_MANCHE; i++) {
            ...
            relancerDes(mainDeDes.getFaceVisible(), NOMBRE_TOURS, mainDeDes, combinaison);
            nbrPoints += résultat.resultatPoint();
